...
const patientModel = new mongoose.Schema(
  {
    username: {
      ...
      minlength: [4, "Please enter a username that is 4 characters or longer"],
      maxlength: [
        20,
    ...
    emergencyRelation: {
      type: String,
      required: [true, "Please enter the name of your emergency relation."],
      validate: [
        {
          validator: function (value) {
            return /^[A-Za-z\s]+$/.test(value);
      ...
      type: [
        {
          path: {
            type: String,
            required: [true, "Please enter the path of the document."],
          },
          originalname: {
            type: String,
            required: [true, "Please enter the original name of the document."],
          },
        },
      ],
      default: [],
